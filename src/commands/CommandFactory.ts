...
import { ITerminalCommand } from './BaseCommand.js';
...
export class CommandFactory {
    /** Singleton instance of the CommandFactory */
    private static instance: CommandFactory;

    /** Map of command names to their constructor functions */
    private commandConstructors: Map<string, new (...args: any[]) => ITerminalCommand> = new Map();
     ...
     */
    createCommand(commandName: string, commandsMap?: Map<string, ITerminalCommand>): ITerminalCommand | null {
     ...
     */
    createAllCommands(): Map<string, ITerminalCommand> {
        const commands = new Map<string, ITerminalCommand>();
